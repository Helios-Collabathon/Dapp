import { AbiRegistry, Address, QueryRunnerAdapter, TransactionsFactoryConfig, TransactionComputer } from '@multiversx/sdk-core'
import { SmartContractQueriesController, SmartContractTransactionsFactory } from '@multiversx/sdk-core/out'
...
export default class PersonaSC {
  ...
  public async removeWallet(sender: Address, wallet: Wallet): Promise<Uint8Array> {
