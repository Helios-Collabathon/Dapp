...
export default function PersonaFilterComponent({
  ...
  const FilterDialog = ({
    ...
    return (
      ...
      >
        <Strong className="w-full text-center text-lg sm:text-xl">
          Filter Options
        </Strong>
        <Dropdown>
        ...
        <Button outline className="w-full mt-4" onClick={onClose}>
          Apply Filters
        </Button>
      </Dialog>
    );
  ...
  return (
    <div className="flex w-full">
      ...
      <div className="hidden sm:flex sm:w-full">
        <div className="grid grid-cols-3 w-full gap-4 sm:flex-row sm:items-center">
          <Dropdown>
