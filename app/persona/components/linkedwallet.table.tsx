  ...
  return (
    <>
      ...
      >
        <TableHead>
          <TableRow>
            <TableHeader className="w-full text-sm sm:text-base">
              Address
            </TableHeader>
      ...
      <Button
        className="mt-2 w-full text-sm sm:w-fit sm:text-base"
        outline
      ...
      <Dialog open={isDialogOpen} onClose={() => setIsDialogOpen(false)}>
        <div className="flex flex-col justify-center gap-2 p-4 sm:p-6">
          <h1 className="mb-4 text-center text-xl font-bold text-black dark:text-white sm:text-2xl">
            Add Wallet
          </h1>
          <Dropdown>
      ...
      {txn && connectedWallet.chain != Chain.MultiversX && (
        <CompletedTransactionDialog txn={txn} message={dialogMsg} />
      )}
    </>
  );
}
