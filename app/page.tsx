    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        <h1 className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 text-center text-lg font-bold backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
          Welcome to Helios Connect: The Future of Cross-Chain Verification. An
          open-source project from the Helios Collabathon! Explore our features
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-3 lg:text-left">
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Contribute to the project, explore the codebase, and help us shape
            the future of cross-chain verification dApp.
          </p>
        </a>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Read our documentation to learn how to use and contribute to Helios
            Connect.
          </p>
        </a>
        ...
        >
          ...
          <p className="m-0 max-w-[30ch] text-sm opacity-50">
            Follow @HeliosStaking to stay updated with the latest developments
            and community news.
          </p>
        </a>
      </div>
